...
`python-luckyluks_1.0.2-1_all.deb <https://github.com/jas-per/luckyLUKS/releases/download/v1.0.2/python-luckyluks_1.0.2-1_all.deb>`_

On other distriubutions you can use the following zip-packaged python file:

`luckyLUKS-1.0.2 <https://github.com/jas-per/luckyLUKS/releases/download/v1.0.2/luckyLUKS-1.0.2>`_
...
This file contains all resources and can be executed directly by the python intepreter. Place in :code:`/usr/bin` and change ownership to root::
    ...
    > sudo mv luckyLUKS-1.0.2 /usr/bin/
    > sudo chown root:root /usr/bin/luckyLUKS-1.0.2
    > sudo chmod 755 /usr/bin/luckyLUKS-1.0.2

Then start with :code:`luckyLUKS-1.0.2` on the command line or create a desktop shortcut manually.
